...
[WeatherAppAssessment](https://omar-mazen.github.io/weatherio/)
## Introduction
...
2. Open `index.html` in your web browser using [live server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer) extension of Visual Studio Code
